Crafty.scene (SCENE_ENEMY_TEST, function () {
    ...
    var enemies = ['enemy_blue', 'enemy_brown', 'enemy_red', 'enemy_yellow', 'enemy_purple', 'enemy_green'];
    var sizes = [24, 32, 48, 64];
    ...
    timer.repeat (function () {
        var e = enemy.create ({
            ...
            image: enemies[Math.floor (Math.random () * enemies.length)]
                    + '_' + sizes[Math.floor (Math.random () * sizes.length)]
        });
        e.start ();
